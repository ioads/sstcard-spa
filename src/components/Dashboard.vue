  ...
  <section id="dashboard">
    <mdb-card class="mb-4">
      <mdb-card-body class="d-sm-flex justify-content-between">
        <h4 class="mb-sm-0 pt-2"><span>Dashboard</span>
        </h4>
    ...
    <section class="mt-lg-5">
      <mdb-row>
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            ...
            <mdb-card-body>
              ...
              <mdb-card-text>Pior que a última semana (25%)</mdb-card-text>
            </mdb-card-body>
          </mdb-card>
        </mdb-col>
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            <div class="admin-up">
              <mdb-icon icon="signature" class="warning-color"/>
              <div class="data">
                <p>ASSINATURAS</p>
                <h4>
                  <strong>200</strong>
        ...
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            <div class="admin-up">
              <mdb-icon icon="table" class="light-blue lighten-1"/>
              <div class="data">
                <p>PLANOS</p>
                <h4>
                  <strong>200</strong>
        ...
        <mdb-col xl="3" md="6" class="mb-r">
          <mdb-card cascade class="cascading-admin-card">
            <div class="admin-up">
              <mdb-icon icon="handshake" class="red accent-2"/>
              <div class="data">
                <p>PARCEIROS</p>
                <h4>
                  <strong>2000</strong>
